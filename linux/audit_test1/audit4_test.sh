...
# You look at the code, improve it, and rewrite it.
# Put the code together, run the script, and you'll get a menu, 
# and if you press a certain number, change it so that you can appreciate it
